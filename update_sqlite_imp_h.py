...
class CUpdateSqliteImpH(CUpdateBase, CWriteBase):
	...
	def __get_content(self):
		...
		for method_info in method_list:
			...
			define = "uint32_t {0}({1});".format(func_name, self.get_method_param_list(func_name, method_info))
...
if __name__ == '__main__':
	...
	update = CUpdateSqliteImpH("./obj/user_info_db_handler.h")
